...
<html>
    ...
    <body>
      <div class="container-fluid header">
        <div class="row links">
          <a href="/">Subletr API</a> |
          <a href="https://github.com/stephanielamm/apartments2">Github</a> |
          <a href="http://www.stephanielamm.com">Portfolio</a> |
          <a href="https://www.gitbook.com/book/stephanielamm/subletr/details">Documentation</a>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h1>Subletr Style Guide</h1>
            <hr>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-sm-offset-3">
            ...
            <div class="row">
              <div class="col-xs-4" style="background-color:#76DED7; color: white">
                #76DED7
              </div>
              <div class="col-xs-4" style="background-color:#f00008; color: white">
                #f00008
              </div>
              <div class="col-xs-4" style="background-color:rgba(0,0,0,0.5); color: white">
                 rgba(0,0,0,0.5)
              </div>
            </div>
          </div>
